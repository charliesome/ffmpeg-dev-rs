    ...
    // CODEGEN
    {
        ...
        if !skip_codegen {
            ...
            codegen
                ...
                // blacklist types which cause bindgen to barf on windows
                // see https://github.com/rust-lang/rust-bindgen/issues/1556#issuecomment-658317813
                ...
                .blacklist_function("_seh_filter_dll")
                .blacklist_function("_seh_filter_exe")
                .generate()
